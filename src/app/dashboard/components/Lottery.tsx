                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-row mt-2 justify-center p-8'>
                        <div className='flex flex-col mx-5'>
                            <div className='font-bold text-center'>รางวัลที่ 1</div>
                            <div className='flex justify-center items-center font-light'>{reward.first}</div>
                        </div>
                        <div className='flex flex-col mx-5'>
                            <div className='font-bold text-center'>รางวัลเลขหน้า 3 ตัว</div>
                        ...
                        <div className='flex flex-col mx-5'>
                            <div className='font-bold text-center'>รางวัลเลขท้าย 3 ตัว</div>
                            <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div className='flex flex-col mx-5'>
                            <div className='font-bold text-center'>รางวัลเลขท้าย 2 ตัว</div>
